    ...
    return <div className="bg-white rounded shadow-sm p-4">
            <div className="text-gray-700 flex justify-center flex-col hover:bg-red-100">
                <div className="flex">
                    ...
                    <div className="ml-1 pt-1 flex justify-center flex-col">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 20" stroke-width="1.5" stroke="currentColor" class="size-4">
